...
#include "../lygia/lygia/space/rotate.glsl"
#include "../lygia/lygia/generative/curl.glsl"
...
void _main(){
    ...
    float c1 = step(redCircleSize - n * 0.05, distance(uv - 0.2*desplazamiento1, vec2(0.5 - n * 0.01 * sin(uv * rotate(uv, u_time) * 150.))));
